            ...
            <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
                <div className="container flex h-16 items-center justify-between max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex items-center gap-2 sm:gap-4">
                        ...
                        <Button variant="ghost" size="sm" onClick={openLogin} className="hidden sm:inline-flex active:scale-95 transition-transform">Login</Button>
                        <Button size="sm" onClick={openSignup} className="active:scale-95 transition-transform">Get Started</Button>
                    </div>
                </div>
            </header>
            ...
            <main className="flex-1">
                ...
                <section className="relative py-20 lg:py-32 overflow-hidden">
                    <div className="container relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center space-y-8 max-w-4xl mx-auto">
                            ...
                            <h1 className="text-4xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight text-foreground leading-[1.1] animate-in fade-in slide-in-from-bottom-6 duration-1000 ease-out fill-mode-both">
                            ...
                            <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-200 ease-out fill-mode-both">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4 animate-in fade-in zoom-in-95 duration-700 delay-500 fill-mode-both">
                                <Button size="lg" className="h-12 px-8 text-lg rounded-xl shadow-lg shadow-primary/20 hover:shadow-xl hover:shadow-primary/30 active:scale-95 transition-all font-semibold" onClick={openSignup}>
                                    Start Tracking Free <ArrowRight className="ml-2 w-5 h-5" />
                                </Button>
                                <Button variant="outline" size="lg" className="h-12 px-8 text-lg rounded-xl border-2 hover:bg-secondary/50 active:scale-95 transition-all font-semibold" onClick={() => document.getElementById('how-it-works').scrollIntoView({ behavior: 'smooth' })}>
                                    See How It Works
                                </Button>
                            </div>
                ...
                <section id="about" className="py-24 bg-muted/30 border-y">
                    <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="grid lg:grid-cols-2 gap-16 items-center">
                            ...
                            <div className="relative group animate-in fade-in slide-in-from-right-8 duration-1000 delay-300 fill-mode-both">
                                <div className="aspect-video bg-gradient-to-br from-primary/20 to-secondary/30 rounded-3xl overflow-hidden shadow-2xl flex items-center justify-center p-1 border">
                                    <img
                                        ...
                                        className="w-full h-full object-contain rounded-xl group-hover:scale-[1.05] transition-transform duration-700"
                                    />
                                </div>
                                {/* Floating Badge */}
                ...
                <section className="py-24">
                    <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-16">
                        <h2 className="text-3xl sm:text-4xl font-bold tracking-tight animate-in fade-in slide-in-from-bottom-4 duration-700">Focus on the outcome, not the data entry.</h2>
                        <div className="grid sm:grid-cols-3 gap-8 text-left">
                            <div className="group space-y-4 p-6 rounded-2xl border bg-card hover:shadow-xl hover:-translate-y-1 transition-all duration-300 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-100 fill-mode-both">
                            ...
                            <div className="group space-y-4 p-6 rounded-2xl border bg-card hover:shadow-xl hover:-translate-y-1 transition-all duration-300 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200 fill-mode-both">
                                <div className="h-12 w-12 rounded-xl bg-primary/10 flex items-center justify-center text-primary group-hover:scale-110 transition-transform duration-300">
                            ...
                            <div className="group space-y-4 p-6 rounded-2xl border bg-card hover:shadow-xl hover:-translate-y-1 transition-all duration-300 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300 fill-mode-both">
                                <div className="h-12 w-12 rounded-xl bg-primary/10 flex items-center justify-center text-primary group-hover:scale-110 transition-transform duration-300">
                ...
                <section id="how-it-works" className="py-24 bg-muted/30 border-t">
                    <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-20">
                        ...
                        <div className="grid md:grid-cols-3 gap-8 relative">
                            {/* Connector Line */}
                            <div className="hidden md:block absolute top-[60px] left-[20%] right-[20%] h-0.5 border-t-2 border-dashed border-muted-foreground/20 animate-in fade-in duration-1000 delay-1000" />

                            <div className="relative space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-100 fill-mode-both">
                                <div className="mx-auto h-16 w-16 rounded-full bg-primary flex items-center justify-center text-primary-foreground font-black text-xl z-20 relative hover:scale-110 transition-transform cursor-default">1</div>
                            ...
                            <div className="relative space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300 fill-mode-both">
                                <div className="mx-auto h-16 w-16 rounded-full bg-primary flex items-center justify-center text-primary-foreground font-black text-xl z-20 relative hover:scale-110 transition-transform cursor-default">2</div>
                            ...
                            <div className="relative space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-500 fill-mode-both">
                                <div className="mx-auto h-16 w-16 rounded-full bg-primary flex items-center justify-center text-primary-foreground font-black text-xl z-20 relative hover:scale-110 transition-transform cursor-default">3</div>
                ...
                <section id="features" className="py-24">
                    <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-12">
                            <div className="group flex flex-col gap-3 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-100 fill-mode-both">
                                <div className="p-3 rounded-xl bg-primary/5 w-fit group-hover:bg-primary/10 group-hover:scale-110 transition-all duration-300">
                            ...
                            <div className="group flex flex-col gap-3 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200 fill-mode-both">
                                <div className="p-3 rounded-xl bg-emerald-500/5 w-fit group-hover:bg-emerald-500/10 group-hover:scale-110 transition-all duration-300">
                            ...
                            <div className="group flex flex-col gap-3 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300 fill-mode-both">
                                <div className="p-3 rounded-xl bg-primary/5 w-fit group-hover:bg-primary/10 group-hover:scale-110 transition-all duration-300">
                            ...
                            <div className="group flex flex-col gap-3 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-400 fill-mode-both">
                                <div className="p-3 rounded-xl bg-emerald-500/5 w-fit group-hover:bg-emerald-500/10 group-hover:scale-110 transition-all duration-300">
                            ...
                            <div id="security" className="group flex flex-col gap-3 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-500 fill-mode-both">
                                <div className="p-3 rounded-xl bg-primary/5 w-fit group-hover:bg-primary/10 group-hover:scale-110 transition-all duration-300">
                            ...
                            <div className="group flex flex-col gap-3 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-600 fill-mode-both">
                                <div className="p-3 rounded-xl bg-emerald-500/5 w-fit group-hover:bg-emerald-500/10 group-hover:scale-110 transition-all duration-300">
                ...
                <section className="py-24 border-t">
                    <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="rounded-3xl bg-primary px-8 py-16 sm:px-16 text-center text-primary-foreground space-y-10 shadow-2xl shadow-primary/20 relative overflow-hidden animate-in fade-in zoom-in-95 duration-1000 fill-mode-both">
                            ...
                            <div className="relative z-10 space-y-6">
                                ...
                                <Button size="lg" variant="secondary" className="h-14 px-10 text-xl font-bold rounded-2xl shadow-xl hover:shadow-2xl hover:-translate-y-1 active:scale-95 transition-all" onClick={openSignup}>
