    ...
    return (
        <div className="grid gap-5">
            <div className="space-y-1">
                ...
                <h1 className="text-2xl font-semibold text-foreground leading-snug">Analytics</h1>
            ...
            <Card className="border-dashed border-border bg-muted/50">
                <CardHeader className="flex flex-col items-center justify-center gap-4 text-center">
                    ...
                    <CardTitle className="text-lg font-semibold text-foreground h-2">Analytics coming soon</CardTitle>
                </CardHeader>
